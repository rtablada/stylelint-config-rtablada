  ...
  rules: {
    ...
    'rule-properties-order': [
      ...
      [
        ...
        'display', 'visibility', 'float', 'clear', 'overflow', 'clip',
        ...
        'background-color',
        'background', 'background-image', 'background-repeat', 'background-position', 'background-attachment',
        ...
        'letter-spacing', 'font-kerning', 'word-spacing', 'text-indent', 'white-space',
